...
const injectToHtml = (ar) => {
	...
	data.splice(
		...
		null,
		` <progress id="imageProgress" value="0" max="100"></progress> <a href=".`,ar,`"><img id="preloadedImage" src=".`,ar,`" style="width: 150px; height: 150px; object-fit: cover; object-position: top;" > </a> `
	);
